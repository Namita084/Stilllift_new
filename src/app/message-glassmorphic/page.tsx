...
export default function MessageGlassmorphicPage() {
      ...
      <main className="flex-1 flex flex-col">
        <section className="screen active">
          <div className="container">
            <div className="glassmorphic-message-container">
              <div className={`glassmorphic-message-card ${isRevealed ? 'revealed' : ''}`}>
                <div className="glassmorphic-message-content">
                  <h3 className="glassmorphic-message-title">{selectedMessage.title}</h3>
                  <p className="glassmorphic-message-body">{selectedMessage.message}</p>
                  {isRevealed && (
                    <>
                      ...
                      <div className="glassmorphic-message-actions">
                        <button 
